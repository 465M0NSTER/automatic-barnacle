...
import java.util.Scanner;
 ...
 class Interface {
    ...
    private static final String BASE_SHORT_URL = "http://short.ly/";
    ...
    private static String comHelp(){
        StringBuilder result = new StringBuilder();
        result.append("create - Создать короткую ссылку.\n");
        result.append("delete - Удалить короткую ссылку.\n");
        result.append("info - Получить информацию о ссылки.\n");
        result.append("mylinks - Просмотреть мои короткие ссылки.\n");
        result.append("open - Открыть короткую ссылку.\n");
        result.append("exit - Выйти из сервиса.\n");
        result.append("help - Просмотреть вкоманды.");
        return result.toString();
    }
